                    ...
                    <div  class="row">
                        ...
                        <div  class=" col col-lg-3   col-md-6 col-sm-12" >
                            <div   
                                ...
                                id="dashboardCard"     class=" card  bg-danger  p-2">
                                <p>Admin</p>
                                <?php 
                                    @include "../connection.php";
                        ...
                        <div  class=" col col-lg-3   col-md-6 col-sm-12" >
                            <div   
                                ...
                                id="dashboardCard"   class=" card  bg-primary  p-2">
                                <p>Customer</p>
                                <?php 
                                    @include "../connection.php";
                        ...
                        <div  class=" col col-lg-3   col-md-6 col-sm-12" >
                            <div   
                                ...
                                id="dashboardCard"   class=" card  bg-secondary  p-2">
                                <p>Orders</p>
                                <?php 
                                    @include "../connection.php";
